...
/**
 * Manager que mantiene el EntityManagerFactory y crea EntityManager por petición. Permite init(),
 * reconnect() y close(). Lanza DatabaseUnavailableException si no hay EMF.
 */
public class DBConnectionManager {
  ...
  /**
   * Crea y devuelve un EntityManager nuevo. Lanza DatabaseUnavailableException si EMF no
   * disponible.
   */
