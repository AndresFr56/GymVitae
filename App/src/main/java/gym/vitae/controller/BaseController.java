...
/** Controlador base que proporciona acceso a repositories mediante el Service Container. */
public abstract class BaseController {
   ...
   * @apiNote Nota Este método solo debe ser llamado desde constructores de producción, no en modo
   *     de prueba.
   */
