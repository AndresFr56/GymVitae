...
public class Preferences {
  ...
  public static final String PREFERENCES_ROOT_PATH = "/gym_vitae";
  ...
  public static final String THEME_UI_KEY = "theme";

  public static Color accentColor;

  private static java.util.prefs.Preferences state;

  public static java.util.prefs.Preferences getState() {
    return state;
  }

  public static void init() {
    state = java.util.prefs.Preferences.userRoot().node(PREFERENCES_ROOT_PATH);
  }
