...
public class CheckBoxTableHeaderRenderer extends JCheckBox implements TableCellRenderer {
  ...
  private final transient TableCellRenderer oldCellRenderer;
  ...
  private void checkRow() {
    ...
    for (int i = 1; i < table.getRowCount(); i++) {
      ...
      if (initValue != v) {
        putClientProperty(
            FlatClientProperties.SELECTED_STATE, FlatClientProperties.SELECTED_STATE_INDETERMINATE);
  ...
  public Component getTableCellRendererComponent(
    ...
    JComponent com =
        (JComponent)
            oldCellRenderer.getTableCellRendererComponent(
