...
public class ImageSnapBuffered {
  ...
  private ImageSnapBuffered() {}

  public static Image createSnapshotsImage(
      Component component, Component comBorder, Border border, double systemScaleFactor) {
  ...
  public static void paintBorder(
      Component com, Border border, Graphics g, int x, int y, int width, int height) {
