...
public class RegisterBeneficio extends JPanel {
  ...
  private void init() {
    ...
    txtDescripcion.putClientProperty(
        FlatClientProperties.PLACEHOLDER_TEXT, "Breve descripción del beneficio");
    ...
    contentPanel =
        new JPanel(new MigLayout("wrap 2, fillx, hidemode 3", "[pref!][grow, fill]", ""));
  ...
  public boolean saveBeneficio() {
    try {
      ...
      JOptionPane.showMessageDialog(
          this, "Beneficio registrado exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
