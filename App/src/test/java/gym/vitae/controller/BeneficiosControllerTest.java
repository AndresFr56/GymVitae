...
class BeneficiosControllerTest {
  ...
  class CreateBeneficioValidationTests {
    ...
    void RB_1_5_7_ClasesValidas() {
      ...
      assertThrows(NullPointerException.class, () -> beneficiosController.createBeneficio(dto));
    }
    ...
    void RB_2_5_7_NombreVacio() {
      ...
      assertThrows(IllegalArgumentException.class, () -> beneficiosController.createBeneficio(dto));
    }
    ...
    void RB_3_5_7_NombreLargo() {
      String nombreLargo =
          "Nombre muy muy muy muy muy muy muy muy muy muy muy muy muy muy muy muy muy muy largo con mas de cincuenta caracteres";
      BeneficioCreateDTO dto = new BeneficioCreateDTO();
    ...
    void RB_DTONulo_ValidacionInicial() {
      assertThrows(
          IllegalArgumentException.class, () -> beneficiosController.createBeneficio(null));
    }
  ...
  class UpdateBeneficioValidationTests {
    ...
    void CEV_1_5_todasClasesValidas() {
      ...
      assertThrows(NullPointerException.class, () -> beneficiosController.updateBeneficio(1, dto));
    }
  ...
  class FlowTests {
    ...
    void getBeneficios_ShouldThrowNullPointerException() {
      assertThrows(NullPointerException.class, () -> beneficiosController.getBeneficios());
    }

    @Test
    @DisplayName("getBeneficioById - ID Válido")
    void getBeneficioById_ShouldThrowNullPointerException() {
      assertThrows(NullPointerException.class, () -> beneficiosController.getBeneficioById(1));
    }

    @Test
    @DisplayName("deleteBeneficio - Repositorio nulo")
    void deleteBeneficio_ShouldThrowNullPointerException() {
      assertThrows(NullPointerException.class, () -> beneficiosController.deleteBeneficio(1));
    }
  }
}
