...
class PersonalControllerTest {
  ...
  class PersonalControllerStaticTest {
    ...
    @Order(5)
    @ParameterizedTest(name = "RE-CEI-[14+{index}]")
    ...
    @Order(6)
    @ParameterizedTest(name = "RE-CEI-[19+{index}]")
    @ValueSource(
        strings = {
          "",
          "Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. "
    ...
    @Order(7)
    @ParameterizedTest(name = "RE-CEI-[22+{index}]")
    @ValueSource(strings = {"juan.elcaballo", "juan.com", "JUANl caballo@gmail.com"})
    @DisplayName(
        "RE-CEI-{23-25}: Clases Inválidas [1, 5, 9, 13, -, 19, 22, 26, 27, 28] Campo Email")
    ...
    @Order(8)
    @ParameterizedTest(name = "RE-CEI-[29]")
    @ValueSource(strings = {"2030-01-01"})
    @DisplayName(
        "RE-CEI-{29}: Clases Inválidas [1, 5, 9, 13, 14, 19, 22, 26, 27, - ] Campo Fecha Ingreso")
