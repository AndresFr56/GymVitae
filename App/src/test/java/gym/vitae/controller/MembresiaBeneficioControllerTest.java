...
class MembresiaBeneficioControllerTest {
  ...
  void setUp() {
    ...
    listadoDTO =
        new MembresiaBeneficioListadoDTO(ASOCIACION_ID, "Membresia Estándar", "Clases Grupales");
  ...
  class GetAllTests {
    ...
    void getAll_SuccessWithData() {
      MembresiaBeneficioListadoDTO listadoIncompleto =
          new MembresiaBeneficioListadoDTO(ASOCIACION_ID, null, null);
